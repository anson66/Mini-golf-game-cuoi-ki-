...
void graphics()
{
	...
	else
	{
		...
		window.renderCenter(0, 3 - 32, "BAN DA HOAN THANH GAME!", font48, black);
		window.renderCenter(0, -32, "BAN DA HOAN THANH GAME!", font48, white);
...
void titleScreen()
{
	if (SDL_GetTicks() < 2000)
	{
		...
		window.renderCenter(0, 0 + 3, "AN SON", font32, black);
		window.renderCenter(0, 0, "AN SON", font32, white);
		window.display();
	}
	else
	{
		...
		window.renderCenter(0, 240 - 48 + 3 - 16*5, "AN CHUOT TRAI DE BAT DAU", font32, black);
		window.renderCenter(0, 240 - 48 - 16*5, "AN CHUOT TRAI DE BAT DAU", font32, white);
		window.display();
	}
}
void game()
